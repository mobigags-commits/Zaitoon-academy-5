          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <a
                  href={getPath('admissions')}
                  onClick={(e) => { e.preventDefault(); onNavigate('admissions'); }}
                ...
                <a
                  href={getPath('degrees')}
                  onClick={(e) => { e.preventDefault(); onNavigate('degrees'); }}
            ...
            <div className="lg:col-span-5">
              <div className="bg-gradient-to-b from-[#5e0410] to-[#45020a] rounded-3xl p-6 sm:p-8 border border-red-700/60 shadow-2xl space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-2">
                    <a
                      href={getPath('career-counselor')}
                      onClick={(e) => { e.preventDefault(); onNavigate('career-counselor'); }}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {[
            ...
            return (
              <a
                key={item.id}
                href={getPath(item.id as PageId)}
                onClick={(e) => { e.preventDefault(); onNavigate(item.id as PageId); }}
                className="p-5 rounded-2xl bg-gradient-to-b from-[#690514] to-[#4f030d] border border-red-700/70 hover:border-amber-400 text-left transition-all hover:scale-102 hover:shadow-xl group cursor-pointer block"
              >
